...
$(document).ready(function() {
  ...
  let displayRecipe = meal => {
    ...
    $.ajax({
      ...
      $("#recipe-tron").html(`
          <div id="recipe-tron-inner" class="jumbotron mx-auto border">
            <div class="text-right">
              <p id="calories">Calories will go here!</p>
            </div>
            <div id="title-section">
              <p id="recipe-title" class="text-center">${meal}</p>
              <p id="recipe-origin" class="text-center">Origin Culture: ${
                foodObj.strArea
              }</p>
            </div>
            <div class="row">
  ...
  //on recipe card click scroll to recipe jumbotron div
  $(document).on("click", ".looks-good", function(event) {
